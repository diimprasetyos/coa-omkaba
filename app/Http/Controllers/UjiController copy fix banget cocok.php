...
class UjiController extends Controller
{
    ...
    public function validateData(Request $request)
    {
        ...
        // Validasi logam dan mikrobiologi
        if (isset($request->logam_as) && isset($data_acuan['Logam/As']) && $request->logam_as > $data_acuan['Logam/As']) {
            $is_passed = false;
            $messages[] = 'Logam As melebihi batas acuan';
        }
